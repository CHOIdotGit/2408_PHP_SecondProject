...
class ParentSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for ($i = 0; $i < 100; $i++) {
            $data = [
                'account' => $faker->unique(true)->regexify('[A-Z0-9]{8}'),
                ...
                'family_code' => $faker->unique(true)->bothify(
                    strtoupper($faker->randomLetter()) . $faker->randomDigit() . str_repeat('#', 6)
                ),
            ];
