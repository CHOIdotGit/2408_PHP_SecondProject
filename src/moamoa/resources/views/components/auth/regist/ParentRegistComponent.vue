  ...
  <div class="container">
    ...
    <div class="data-form">
      ...
      <div class="account-group">
        <input v-model="registInfo.account" :class="{ 'err-border' : errMsg.account }" type="text" name="account" id="account" autocomplete="off" required>
      ...
      <input v-model="registInfo.password_chk" :class="{ 'err-border' : errMsg.password_chk }" type="password" name="password_chk" id="password_chk" autocomplete="off" required>
      ...
      <input v-model="registInfo.email" @input="onlyEmail" :class="{ 'err-border' : errMsg.email }" type="email" name="email" id="email" autocomplete="off" required>
    </div>
    ...
    <div class="data-form">
      ...
      <input v-model="registInfo.nick_name" :class="{ 'err-border' : errMsg.nick_name }" type="text" name="nick_name" id="nick_name" autocomplete="off">
      ...
      <input v-model="registInfo.tel" @input="onlyNumber" :class="{ 'err-border' : errMsg.tel }" type="text" name="tel" id="tel" autocomplete="off" required>
